...
class EndpointSpec1 implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the EndpointSpec1 object to a human-readable string representation.
     *
     * @return string The string representation of the EndpointSpec1 object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify('EndpointSpec1', ['mode' => $this->mode, 'ports' => $this->ports]);
    }
