...
class Page implements \JsonSerializable
{
    ...
    /**
     * Converts the Page object to a human-readable string representation.
     *
     * @return string The string representation of the Page object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'Page',
            ['count' => $this->count, 'next' => $this->getNext(), 'previous' => $this->getPrevious()]
        );
    }
