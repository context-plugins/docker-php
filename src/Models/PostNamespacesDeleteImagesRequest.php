 ...
 */
class PostNamespacesDeleteImagesRequest implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the PostNamespacesDeleteImagesRequest object to a human-readable string representation.
     *
     * @return string The string representation of the PostNamespacesDeleteImagesRequest object.
     */
