 ...
 */
class GetNamespaceRepositoryImagesTagsResponse implements \JsonSerializable
{
    /**
     * @var int|null
     */
    ...
    /**
     * Converts the GetNamespaceRepositoryImagesTagsResponse object to a human-readable string
     * representation.
     *
     * @return string The string representation of the GetNamespaceRepositoryImagesTagsResponse object.
     */
