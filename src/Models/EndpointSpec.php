 ...
 */
class EndpointSpec implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the EndpointSpec object to a human-readable string representation.
     *
     * @return string The string representation of the EndpointSpec object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify('EndpointSpec', ['mode' => $this->mode, 'ports' => $this->ports]);
    }
