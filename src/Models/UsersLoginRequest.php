 ...
 * User login details
 */
class UsersLoginRequest implements \JsonSerializable
{
    /**
     * @var string
     */
    ...
    /**
     * Converts the UsersLoginRequest object to a human-readable string representation.
     *
     * @return string The string representation of the UsersLoginRequest object.
     */
