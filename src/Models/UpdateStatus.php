 ...
 */
class UpdateStatus implements \JsonSerializable
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the UpdateStatus object to a human-readable string representation.
     *
     * @return string The string representation of the UpdateStatus object.
     */
