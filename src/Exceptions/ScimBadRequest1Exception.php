...
class ScimBadRequest1Exception extends ApiException
{
    /**
     * @var string|null
     */
     ...
     * @maps scimType
     */
    public function setScimType(?string $scimType): void
    {
        $this->scimType = $scimType;
    }

    /**
     * Converts the ScimBadRequest1Exception object to a human-readable string representation.
     *
     * @return string The string representation of the ScimBadRequest1Exception object.
     */
