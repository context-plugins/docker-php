...
| `networkingConfig` | [`?NetworkingConfig2`](../../doc/models/networking-config-2.md) | Optional | - | getNetworkingConfig(): ?NetworkingConfig2 | setNetworkingConfig(?NetworkingConfig2 networkingConfig): void |

## Example

```php
use DockerLib\Models\Builders\ContainersCreateRequestBuilder;
use DockerLib\ApiHelper;

$containersCreateRequest = ContainersCreateRequestBuilder::init()
    ->argsEscaped(false)
    ->attachStderr(true)
    ->attachStdin(false)
    ->attachStdout(true)
