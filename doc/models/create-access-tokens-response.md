...
```php
use DockerLib\Models\Builders\CreateAccessTokensResponseBuilder;

$createAccessTokensResponse = CreateAccessTokensResponseBuilder::init()
    ->clientId('HUB')
