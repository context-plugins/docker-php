...
# Post Namespaces Delete Images Request
...
```php
use DockerLib\Models\Builders\PostNamespacesDeleteImagesRequestBuilder;
...
$postNamespacesDeleteImagesRequest = PostNamespacesDeleteImagesRequestBuilder::init()
