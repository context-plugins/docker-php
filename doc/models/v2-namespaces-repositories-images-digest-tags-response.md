...
# V2 Namespaces Repositories Images Digest Tags Response
...
```php
use DockerLib\Models\Builders\V2NamespacesRepositoriesImagesDigestTagsResponseBuilder;
use DockerLib\Models\Builders\Result1Builder;

$v2NamespacesRepositoriesImagesDigestTagsResponse = V2NamespacesRepositoriesImagesDigestTagsResponseBuilder::init()
    ->count(100)
