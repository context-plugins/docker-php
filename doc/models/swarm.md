...
| `joinTokens` | [`?JoinTokens1`](../../doc/models/join-tokens-1.md) | Optional | - | getJoinTokens(): ?JoinTokens1 | setJoinTokens(?JoinTokens1 joinTokens): void |

## Example

```php
use DockerLib\Models\Builders\SwarmBuilder;
